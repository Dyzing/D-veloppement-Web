...
--
-- Client :  localhost
-- Généré le :  Mer 12 Février 2020 à 15:49
...
(824, 'BRYANT', 'Kobe', '2, Mamba Road', 'Los Angeles', 2482);
...
--
ALTER TABLE `proprietaire`
  MODIFY `id_pers` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=825;
